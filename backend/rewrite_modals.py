...
# Find <!-- Universal Modals -->
start_idx = content.find('<!-- Universal Modals -->')

new_modals_and_script = """<!-- Universal Modals -->
 ...
 <input type="text" name="name" x-model="modal.name" required class="block w-full bg-theme-bg text-theme-text-primary border-theme-input-border rounded-xl px-4 py-2.5 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm shadow-sm" placeholder="e.g. Kathmandu">
 </div>
 ...
 <input type="number" step="0.01" name="rate" x-model="modal.rate" required class="block w-full bg-theme-bg text-theme-text-primary border-theme-input-border rounded-xl px-4 py-2.5 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm shadow-sm">
 </div>
 
 <div>
 <label class="block text-sm font-bold text-theme-text-secondary mb-1">Estimated Days</label>
 <input type="text" name="estimated_days" x-model="modal.estimated_days" placeholder="e.g. 1-2 Days" class="block w-full bg-theme-bg text-theme-text-primary border-theme-input-border rounded-xl px-4 py-2.5 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm shadow-sm">
 </div>
 ...
 <input type="number" step="0.01" name="is_free_above" x-model="modal.is_free_above" class="block w-full bg-theme-bg text-theme-text-primary border-theme-input-border rounded-xl px-4 py-2.5 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm shadow-sm">
 </div>
...
content = content[:start_idx] + new_modals_and_script
with open(filepath, 'w') as f:
    f.write(content)
print("Restored and re-written modals correctly")
