...
class VTOProductListView(SuperUserRequiredMixin, SearchFilterMixin, ListView):
    model = VTOProduct
...
class VTOProductCreateView(SuperUserRequiredMixin, TailwindFormViewMixin, CreateView):
    model = VTOProduct
    template_name = 'admin/fitting/vtoproduct/form.html'
    fields = '__all__'
    success_url = reverse_lazy('admin:vtoproduct_list')

class VTOProductUpdateView(SuperUserRequiredMixin, TailwindFormViewMixin, UpdateView):
    model = VTOProduct
    template_name = 'admin/fitting/vtoproduct/form.html'
    fields = '__all__'
    success_url = reverse_lazy('admin:vtoproduct_list')
