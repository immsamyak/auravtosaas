...
class VTOProductAssetsListView(PlatformAdminRequiredMixin, SearchFilterMixin, ListView):
...
class VTOProductAssetsCreateView(PlatformAdminRequiredMixin, TailwindFormViewMixin, CreateView):
    model = VTOProductAssets
    template_name = 'admin/fitting/vtoproductassets/form.html'
    fields = '__all__'
    success_url = reverse_lazy('admin:vtoproductassets_list')

class VTOProductAssetsUpdateView(PlatformAdminRequiredMixin, TailwindFormViewMixin, UpdateView):
    model = VTOProductAssets
    template_name = 'admin/fitting/vtoproductassets/form.html'
    fields = '__all__'
    success_url = reverse_lazy('admin:vtoproductassets_list')
