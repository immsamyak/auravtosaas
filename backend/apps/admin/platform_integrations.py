...
class PlatformIntegrationListView(SuperUserRequiredMixin, SearchFilterMixin, ListView):
...
class PlatformIntegrationCreateView(SuperUserRequiredMixin, TailwindFormViewMixin, CreateView):
    model = PlatformIntegration
    template_name = 'admin/core/platformintegration/form.html'
    fields = '__all__'
    success_url = reverse_lazy('admin:platformintegration_list')

class PlatformIntegrationUpdateView(SuperUserRequiredMixin, TailwindFormViewMixin, UpdateView):
    model = PlatformIntegration
    template_name = 'admin/core/platformintegration/form.html'
    fields = '__all__'
    success_url = reverse_lazy('admin:platformintegration_list')
