...
class FitPassportListView(SuperUserRequiredMixin, SearchFilterMixin, ListView):
    model = FitPassport
...
class FitPassportCreateView(SuperUserRequiredMixin, TailwindFormViewMixin, CreateView):
    model = FitPassport
    template_name = 'admin/fitting/fitpassport/form.html'
    fields = '__all__'
    success_url = reverse_lazy('admin:fitpassport_list')

class FitPassportUpdateView(SuperUserRequiredMixin, TailwindFormViewMixin, UpdateView):
    model = FitPassport
    template_name = 'admin/fitting/fitpassport/form.html'
    fields = '__all__'
    success_url = reverse_lazy('admin:fitpassport_list')
