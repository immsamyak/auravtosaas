...
urlpatterns = [
    path('store/<slug:slug>/try-on/<int:variant_id>/', views.try_on_view, name='try_on'),
    path('store/<slug:slug>/try-on/<int:variant_id>/upload/', views.guest_photo_upload_view, name='guest_photo_upload'),
