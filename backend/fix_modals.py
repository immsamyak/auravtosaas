...
# Replace from Universal Modals down to the end of the component
start_marker = "<!-- Universal Modals -->"
end_marker = "</div> <!-- CLOSE x-data=\"shippingDashboard()\" DIV -->"
